...
#include "GAInGameHit.h"

#include "AbilitySystemComponent.h"
#include "UEReconnect/InGame/GAS/GameplayEffects/GEInGameSimpleModifyHealth.h"

UE_DEFINE_GAMEPLAY_TAG(TAG_Abilities_Hit, "Abilities.Hit");

UGAInGameHit::UGAInGameHit()
{
	// Default to Instance Per Actor
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;

	AbilityTags.AddTag(TAG_Abilities_Hit.GetTag());
}

void UGAInGameHit::ActivateAbility(
